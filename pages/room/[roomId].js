  ...
  return (
    <div className="h-[100vh] w-[100vw] ">
      <Navbar
        ...
        setMutedIncoming={setMutedIncoming}
        mutedIncoming={mutedIncoming}
        paused={paused}
      />
          ...
          <div className="compiler-container ">
            ...
            <div className="compiler-options-bar relative flex justify-between items-center bg-white">
              {userLoggedIn && (
                <div>
                  <div
                    className=" bg-cyan-200 p-[5px] rounded-[5px] mx-[10px] text-black font-bold cursor-pointer"
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <path d="M21 20V8.414a1 1 0 0 0-.293-.707l-4.414-4.414A1 1 0 0 0 15.586 3H4a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1zM9 8h4a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2zm7 11H8v-4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z" />
                    </svg>
                  </div>
                </div>
              )}
              <div className="flex justify-around items-center w-[80%] md:w-[50%] absolute right-0 ">
                <Dropdown data={themes} val={theme} setVal={setTheme} />
                <Dropdown
                  data={languages}
                  val={language}
                  setVal={setLanguage}
                ...
                <button
                  className="w-[90px] h-[30px] text-center rounded-[5px] cursor-pointer border-[2px] border-gray-500 font-bold flex justify-center items-center"
        ...
        <div className="main-sub-container">
          ...
          <div className="io-container-main">
            <div className="io-container-sub flex flex-col ">
              {/* input */}
              <div className="h-[15%] w-full max-h-[30px] font-bold flex items-center pl-[10px] bg-white">
                Input
              </div>
              <div className="grow">
                <Editor
